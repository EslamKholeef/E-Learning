...
namespace DistanceLearning.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Roles = new SelectList(db.Roles.Where(a => a.Name != "Admins"), "Name", "Name");
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase ProfileImg)
        {
            ViewBag.Roles = new SelectList(db.Roles.Where(a=> a.Name != "Admins"), "Name", "Name");
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser {UserName = model.UserName, Email = model.Email, UserType = model.UserType , ProfileImg = model.ProfileImg, AboutUser = model.AboutUser};
        ...
        public ActionResult EditProfile (string Name, string OldPassword ,string NewPassword, string AboutUser)
        {
            ...
            if (!UserManager.CheckPassword(user,OldPassword))
            {
                ...
                TempData["EditState"] = "Wrong Password !";
                AuthenticationManager.SignOut(DefaultAuthenticationTypes.ApplicationCookie);
